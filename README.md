...
- `FE/` — Frontend application (not yet added)
...
Notes:
- Put your frontend sources in `FE/` and database SQL in `BE/init/` so they are automatically loaded by the MySQL container on first start.
